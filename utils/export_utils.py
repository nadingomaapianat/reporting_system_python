...
INCIDENT_TABLE_COLUMN_ORDERS = {
    'overallStatuses': [
        ('code', 'Code'), ('occurrenceDate', 'Occurance Date'), ('reportedDate', 'Reported Date'),
        ...
        ('causeName', 'Cause'), ('rcm', 'RCM'), ('kriName', 'KRI'), ('discoveredType', 'Discover By'),
        ...
        ('recoveryAmount', 'Recoveries Amount'), ('netLoss', 'Net Loss'), ('preparerStatus', 'Incident Status'),
        ('reviewerStatus', 'Review'), ('checkerStatus', 'Fist Approval'), ('acceptanceStatus', 'Second Approval'),
    ...
    'incidentsFinancialDetails': [
        ...
        ('subCategoryName', 'Sub Category'), ('description', 'Description'), ('rootCause', 'Root Cause'),
        ('causeName', 'Cause'), ('rcm', 'RCM'), ('kriName', 'KRI'), ('discoveredType', 'Discover By'),
        ('netLoss', 'Net Loss'), ('totalLoss', 'Total loss'), ('recoveryAmount', 'Recoveries Amount'),
        ('grossAmount', 'Gross Amount'), ('financialImpactName', 'Financial Impact'), ('currencyName', 'Currency'),
        ('exchangeRate', 'Exchange Rate'), ('financialEquivalent', 'Financial Equivalent (LYC)'),
        ('eventType', 'Event Type'), ('preparerStatus', 'Incident Status'), ('reviewerStatus', 'Review'),
        ('checkerStatus', 'Fist Approval'), ('acceptanceStatus', 'Second Approval'), ('status', 'Status'),
        ('createdAt', 'Created At'),
    ],
    'incidentsWithTimeframe': [
        ('code', 'Code'), ('importance', 'Importance'), ('reportedDate', 'Reported Date'),
        ('occurrenceDate', 'Occurance Date'), ('owner', 'Owner'), ('incident_name', 'Incident Name'),
        ...
        ('kriName', 'KRI'), ('discoveredType', 'Discover By'), ('totalLoss', 'Total loss'),
        ('recoveryAmount', 'Recoveries Amount'), ('netLoss', 'Net Loss'),
        ('financialImpactName', 'Financial Impact'), ('currencyName', 'Currency'),
        ('exchangeRate', 'Exchange Rate'), ('financialEquivalent', 'Financial Equivalent (LYC)'),
        ('recoveryStatus', 'Recovery Status'), ('eventType', 'Event Type'), ('preparerStatus', 'Incident Status'),
        ('reviewerStatus', 'Review'), ('checkerStatus', 'Fist Approval'), ('acceptanceStatus', 'Second Approval'),
    ...
    'incidentsWithFinancialAndFunction': [
        ...
        ('discoveredType', 'Discover By'), ('totalLoss', 'Total loss'), ('currencyName', 'Currency'),
        ('exchangeRate', 'Exchange Rate'), ('financialEquivalent', 'Financial Equivalent (LYC)'),
        ('recoveryStatus', 'Recovery Status'), ('eventType', 'Event Type'),
        ('recoveryAmount', 'Recoveries Amount'), ('netLoss', 'Net Loss'), ('preparerStatus', 'Incident Status'),
        ('reviewerStatus', 'Review'), ('checkerStatus', 'Fist Approval'), ('acceptanceStatus', 'Second Approval'),
    ...
    'netLossAndRecovery': [
        ...
        ('recovery_amount', 'Recoveries Amount'), ('preparerStatus', 'Incident Status'), ('reviewerStatus', 'Review'),
        ('checkerStatus', 'Fist Approval'), ('acceptanceStatus', 'Second Approval'), ('createdAt', 'Created At'),
    ],
}
...
INCIDENT_TABLE_COLUMN_ORDERS_PDF = {
    ...
    'netLossAndRecovery': [
        ...
        ('net_loss', 'Net Loss'), ('recovery_amount', 'Recoveries Amount'),
    ],
}
