...
curl "https://reporting-demo-system-python.pianat.ai/api/grc/risks/export-pdf"

# Export specific risk card as Excel
curl "https://reporting-demo-system-python.pianat.ai/api/grc/risks/export-excel?cardType=totalRisks&onlyCard=true"

# Export with date range
curl "https://reporting-demo-system-python.pianat.ai/api/grc/controls/export-pdf?startDate=2024-01-01&endDate=2024-12-31"
```
...
```python
API_CONFIG = {
    'node_api_url': 'https://reporting-demo-system-backend.pianat.ai',
    'python_api_url': 'https://reporting-demo-system-python.pianat.ai',
    'timeout': 30
}
```
