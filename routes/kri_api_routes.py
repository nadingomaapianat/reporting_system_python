...
async def export_kris_pdf(
    ...
    try:
        ...
        # Tables
            ...
            data = await kri_service.get_kri_details_with_action_plans(startDate, endDate, user_id=user_id, group_name=group_name, function_id=function_id)
        else:
...
async def export_kris_excel(
    ...
    try:
        ...
        # Extract user and function for filtered exports (same as PDF)
        user_id, group_name, function_id = extract_user_and_function_params(request)
