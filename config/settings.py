...
API_CONFIG = {
    'node_api_url': os.getenv('NODE_API_URL', os.getenv('NODE_BACKEND_URL', 'https://dcc-reporting-api-node.theubeg.ub.dom')),
    'python_api_url': os.getenv('PYTHON_API_URL', os.getenv('PYTHON_API_BASE', 'https://dcc-reporting-api-py.theubeg.ub.dom')),
