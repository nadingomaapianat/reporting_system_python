...
API_CONFIG = {
    'node_api_url': os.getenv('NODE_API_URL', os.getenv('NODE_BACKEND_URL', 'https://reporting-demo-system-python.pianat.ai')),
    'python_api_url': os.getenv('PYTHON_API_URL', os.getenv('PYTHON_API_BASE', 'https://reporting-demo-system-python.pianat.ai')),
    'timeout': int(os.getenv('API_TIMEOUT', '60')),
    'grc_backend_url': (os.getenv('GRC_BACKEND_URL') or os.getenv('NODE_API_URL') or os.getenv('NODE_BACKEND_URL') or 'https://apidemo.pianat.ai').rstrip('/'),
}
