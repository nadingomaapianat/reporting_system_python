...
2. Visit: https://dcc-reporting-api-node.theubeg.ub.dom/api/charts/dashboard
3. Or use the frontend: https://dcc-reporting-api-node.theubeg.ub.dom/auto-dashboard
    """)
