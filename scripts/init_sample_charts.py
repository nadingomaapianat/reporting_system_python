...
2. Visit: https://reporting-madinetmasr-system-backend.comply.now/api/charts/dashboard
3. Or use the frontend: https://reporting-madinetmasr-system-backend.comply.now/auto-dashboard
    """)
