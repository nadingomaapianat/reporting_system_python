...
2. Visit: https://reporting-madinetmasr-system-backend.pianat.ai/api/charts/dashboard
3. Or use the frontend: https://reporting-madinetmasr-system-backend.pianat.ai/auto-dashboard
    """)
